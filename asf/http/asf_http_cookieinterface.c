...
zend_function_entry asf_http_cookieinterface_methods[] = {
    ...
    PHP_ABSTRACT_ME(asf_http_cookieinterface, forever, asf_http_cookieinterface_forever_arginfo)
    ...
    PHP_ABSTRACT_ME(asf_http_cookieinterface, del, asf_http_cookieinterface_has_arginfo)
